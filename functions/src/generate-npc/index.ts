...
import type { Characteristics as RemoteCharacteristics } from './npc-gen-client/types.gen';
...
const handler: Handler = async (event: HandlerEvent, context: HandlerContext) => {
  ...
  try {
    ...
    if (result.error == null) {
      ...
      const formatCharacteristics = (characteristics: RemoteCharacteristics): Characteristics =>{
        return {
          STR: { value: characteristics.STR, modifier: characteristicModifier(characteristics.STR)},
          DEX: { value: characteristics.DEX, modifier: characteristicModifier(characteristics.DEX)},
          END: { value: characteristics.END, modifier: characteristicModifier(characteristics.END)},
          INT: { value: characteristics.INT, modifier: characteristicModifier(characteristics.INT)},
          EDU: { value: characteristics.EDU, modifier: characteristicModifier(characteristics.EDU)},
          SOC: { value: characteristics.SOC, modifier: characteristicModifier(characteristics.SOC)}
        };
      }
